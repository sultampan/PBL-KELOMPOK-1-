<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="index.php?page=social" class="menu-item <?= $page==='social' ? 'active' : '' ?>">
        ...
        <div class="sidebar-toggle-wrapper" style="margin-top: 5px;">
    ...
    <div class="sidebar-footer">
        <a href="logout.php" class="menu-item logout-item" onclick="return confirm('Yakin logout?')">
