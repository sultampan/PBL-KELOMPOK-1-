<header id="site-header" class="fixed-top">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
            ...
            <h1>
                <a class="navbar-brand position-absolute logo-fixed" href="index.php?page=home">
                    <img src="assets/images/logo.png" alt="Applied Informatics Lab">
                </a>
            </h1>

            <!-- Tambahkan kotak putih transparan -->
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav mx-lg-auto my-2 my-lg-0 navbar-nav-scroll">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=facility">Facility</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=activity">Activity</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="overlay overlay-slidedown">
                    ...
                    <nav class="w3l-formhny">
                        <form class="d-sm-flex search-header">
