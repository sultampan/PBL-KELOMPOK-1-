...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="content-box">
            ...
            switch ($page) {
                case 'activity':
                    include __DIR__ . '/../../src/module/activity/index.php';
                    break;
                case 'fasilitas':
                    include __DIR__ . '/../../src/module/fasilitas/index.php';
                    break;
                case 'member':
                    include __DIR__ . '/../../src/module/member/index.php';
                    break;
                case 'produk':
                    include __DIR__ . '/../../src/module/produk/index.php';
                    break;
