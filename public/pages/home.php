<section class="w3l-main-slider banner-slider" id="home">
    ...
    <style>
        ...
        /* Wrapper Gambar agar rapi di tengah */
        .product-img-box {
            width: 100%;
        ...
        .product-img-box img {
            max-width: 100%;
            max-height: 100%;
            object-fit: contain; /* Gambar utuh tidak terpotong/zoom */
        ...
        .product-desc {
            ...
            margin-bottom: 20px;
            display: -webkit-box;
            -webkit-line-clamp: 3; /* Batasi deskripsi 3 baris */
            -webkit-box-orient: vertical;
            overflow: hidden;
    ...
    <section class="w3l-features py-5" id="work">
        <div class="container py-lg-5 py-md-4 py-2">
            ...
            <div class="title-content text-center mb-lg-5 mb-4">
                ...
                <h3 class="title-w3l">Innovative Solutions by Applied Informatics Laboratory</h3>
            </div>
                ...
                <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-6 mt-4">
                                <div class="product-card">
                                    ...
                                    <div class="product-img-box">
                                        ...
                                        // Link Detail untuk gambar
                                        $detailLink = "index.php?page=product-detail&id=" . $p['id_produk'];
                                        ?>
                                        <a href="<?php echo $detailLink; ?>" style="display:contents;">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <a href="<?php echo $detailLink; ?>" class="product-btn">
                    ...
                    <?php else: ?>
                        <div class="col-12 text-center py-5">
                            <p class="text-muted">Belum ada data produk yang ditampilkan.</p>
                        </div>
                    <?php endif; ?>
                </div>

                <div class="text-center mt-5">
                    <a href="index.php?page=product" class="btn btn-style btn-primary mt-lg-4 mt-3">
                        View All Products <i class="fas fa-angle-double-right ms-2"></i>
                    </a>
                </div>
            </div>
        </div>
